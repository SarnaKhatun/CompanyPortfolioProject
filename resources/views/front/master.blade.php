...
<head>
    ...
    <title>Company Bootstrap Template | @yield('title')</title>
...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="{{route('/')}}"><span>Com</span>pany</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="{{asset('/')}}front-assets/img/logo.png" alt="" class="img-fluid"></a>-->
            ...
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>About</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        ...
                        <li><a href="{{route('show.testimonial')}}">Testimonials</a></li>
                    </ul>
                </li>

                <li><a href="{{route('show.service')}}">Services</a></li>
                <li><a href="{{route('show.portfolio')}}">Portfolio</a></li>
                <li><a href="{{route('show.price')}}">Pricing</a></li>
                <li><a href="{{route('show.blog')}}">Blog</a></li>
                <li><a href="{{route('create-message')}}">Contact</a></li>
