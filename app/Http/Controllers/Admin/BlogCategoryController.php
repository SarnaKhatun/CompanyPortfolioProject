...
class BlogCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message', 'Blog category data created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('blogCategories.index'))->with('message', 'Blog category data updated successfully');
    }
    ...
    {
        $this->changeItem = BlogCategory::find($id);
